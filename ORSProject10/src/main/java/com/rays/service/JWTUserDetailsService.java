 ...
 * Loads user details from the database and provides them
...
public class JWTUserDetailsService implements UserDetailsService {
	...
	/**
	 * Creates and returns BCrypt password encoder bean.
	 *
	 ...
	 * @return UserDetails object containing user credentials
